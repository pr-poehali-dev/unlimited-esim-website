...
const countriesData = {
  turkey: {
    ...
    additionalInfo: {
      ...
      language: "Турецкий",
      electricity: "220V, евророзетки типа C и F",
      bestTime: "Апрель-июнь, сентябрь-ноябрь",
      touristAreas: ["Стамбул", "Анталья", "Каппадокия", "Памуккале", "Бодрум"],
      internetUsage:
        "Высокая скорость интернета особенно важна в крупных городах вроде Стамбула и Анкары, где активно используются навигационные сервисы и приложения для вызова такси.",
      tips: [
        "Загрузите карты для офлайн-использования",
        "Установите приложение BiTaksi для вызова такси в Стамбуле",
        "Используйте VPN для доступа к некоторым заблокированным сервисам",
      ],
    },
  },
  thailand: {
    ...
    additionalInfo: {
      ...
      language: "Тайский, английский в туристических зонах",
      electricity: "220V, используются розетки типа A, B, C, O",
      bestTime: "Ноябрь-февраль (сухой сезон)",
      touristAreas: ["Бангкок", "Пхукет", "Краби", "Паттайя", "Чиангмай"],
      internetUsage:
        "Интернет особенно полезен для навигации на островах и в отдалённых регионах, где сложно найти англоговорящих местных жителей.",
      tips: [
        "Используйте приложение Grab для заказа такси",
        "Скачайте переводчик с тайского языка",
        "Установите приложение для конвертации валют",
      ],
    },
  },
  egypt: {
    ...
    additionalInfo: {
      ...
      language: "Арабский, английский в туристических зонах",
      electricity: "220V, используются розетки типа C и F",
      bestTime: "Октябрь-апрель (не слишком жарко)",
      touristAreas: [
        "Каир",
        "Луксор",
        "Хургада",
      ...
      internetUsage:
        "Интернет необходим для навигации в крупных городах и для связи с гидами при посещении исторических достопримечательностей.",
      tips: [
        "Рекомендуется использовать VPN для стабильной работы некоторых приложений",
        "Загрузите офлайн-карты исторических мест",
        "Установите приложение для перевода с арабского",
      ],
    },
  },
  china: {
    ...
    additionalInfo: {
      ...
      language: "Китайский (мандаринский), ограниченный английский",
      electricity: "220V, используются розетки типа A, C и I",
      bestTime: "Апрель-май, сентябрь-октябрь",
      touristAreas: ["Пекин", "Шанхай", "Сиань", "Гуанчжоу", "Гонконг"],
      internetUsage:
        "В Китае заблокированы многие западные сервисы (Google, Facebook, WhatsApp). Обязательно нужен надежный VPN и локальные приложения вроде WeChat и Baidu Maps.",
      tips: [
        "Обязательно установите VPN до приезда в Китай",
        "Скачайте приложения DiDi для такси и WeChat для коммуникации",
        "Загрузите офлайн-переводчик с китайского языка",
      ],
    },
  },
};
