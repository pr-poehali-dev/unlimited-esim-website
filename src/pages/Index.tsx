...
const countries = [
  {
    id: "turkey",
    name: "Турция",
    image: "https://images.unsplash.com/photo-1589561454226-796a8aa89b05?q=80&w=500&auto=format&fit=crop",
    description: "Безлимитный интернет для отдыха на побережье или шоппинга в Стамбуле",
  },
  {
    id: "thailand",
    name: "Таиланд",
    image: "https://images.unsplash.com/photo-1504214208698-ea1916a2195a?q=80&w=500&auto=format&fit=crop",
    description: "Оставайтесь на связи на любом из экзотических островов",
  },
  {
    id: "egypt",
    name: "Египет",
    image: "https://images.unsplash.com/photo-1539768942893-daf53e448371?q=80&w=500&auto=format&fit=crop",
    description: "Надежный интернет для отдыха на курортах Красного моря",
  },
  {
    id: "china",
    name: "Китай",
    image: "https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?q=80&w=500&auto=format&fit=crop",
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              Получить eSIM и оставаться на связи во время путешествий еще никогда не было так просто
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Выберите страну и подходящий тарифный план для вашего путешествия</p>
              </div>
              <div className="text-center">
                <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-primary">2</span>
                </div>
                <h3 className="text-xl font-semibold mb-2">Оплатите и получите eSIM</h3>
                <p className="text-gray-600">Оплатите покупку и мгновенно получите QR-код для активации</p>
              </div>
              <div className="text-center">
                <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-primary">3</span>
                </div>
                <h3 className="text-xl font-semibold mb-2">Наслаждайтесь связью</h3>
                <p className="text-gray-600">Отсканируйте QR-код с помощью телефона, и ваш eSIM активируется автоматически</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-primary text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Готовы к путешествию?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {countries.map((country) => (
                  <li key={country.id}>
                    <a href={`/country/${country.id}`} className="hover:text-white transition-colors">
                      {country.name}
                    </a>
                  </li>
                ))}
